-- Active: global_127.0.0.1_3306_root@@127.0.0.1@3306@blog
...
ALTER TABLE `billets` ADD PRIMARY KEY (`id`);

ALTER TABLE
    `billets` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 3;

-- Renommer la table

ALTER TABLE `billets` RENAME `posts`;

-- Renommer un champ

ALTER TABLE
    `posts` CHANGE `french_creation_date` `creation_date` datetime NOT NULL;

ALTER TABLE `posts` ADD PRIMARY KEY (`id`);

ALTER TABLE
    `posts` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 3;
...
VALUES (
        ...
        1,
        'Sam',
        'Quelqu\'un a un avis là-dessus ? Je ne sais pas quoi en penser.',
        '2022-03-03 13:01:42'
    );
